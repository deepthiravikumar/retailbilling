...
export const deleteCategory = async (catrgoryId) => {
    return await axios.delete(`http://localhost:8080/api/v1.0/admin/categories/${catrgoryId}`,{headers:{'Authorization':`Bearer ${localStorage.getItem('token')}`}});
}
